...
const resources: Record<string, Record<string, string>> = {
  zh: {
    ...
    "Thinking mode prices": "区分思考模式",
    "Non-thinking output price": "非思考输出价格",
    "Thinking output price": "思考输出价格",
    "Thinking request parameter": "思考模式请求参数",
    "Preview request mode": "预览请求模式",
    "Non-thinking mode": "非思考模式",
    "Thinking mode": "思考模式",
    "Video input price": "视频输入价格",
    "Video output price": "视频输出价格",
    "Audio-only output pricing": "音频输出时仅按音频计费",
    "Text output price (without audio)": "文本输出价格（无音频时）",
    "When audio output tokens are present, text output tokens are not charged; only the audio output price is used.":
      "当响应包含音频输出 Token 时，不再收取文本输出 Token 费用，只按照音频输出价格计费。",
    "Custom table": "自定义表格",
    "Input price": "输入价格",
    "Output price": "输出价格",
    Unit: "单位",
